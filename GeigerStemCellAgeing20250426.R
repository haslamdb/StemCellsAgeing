...
Metadata$Groups<-gsub("RAG1-Young_HSCs", "DY", Metadata$Groups)
Metadata$Groups<-gsub("RAG1-Old_HSCs", "DO", Metadata$Groups)
...
#TODO: 
### How about looking at distance on PC1 alone (For figure 1B)?
### This will show that DY and Y are quite close whereas RAG1-/- is more distant
...
save.image(file="GeigerData20250501")
...
ggsave(filename = "SuppFigure1B.pdf", plot = Recipient_Effect, width = 12,
...
ggsave(filename = "YoungvsOldHSCL_Species_Effect.pdf", plot = YoungOldHSCEffect, width = 12,
       height = 16, limitsize = FALSE)
...
## Alight for figures: need to get Figure 4 (PCA of organisms differentially abundant species in Young vs Old transplanted mice)
